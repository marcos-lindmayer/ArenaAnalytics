...
function IconClass.new(iconfile, IconFileX, IconFileY, StartX, EndX, StartY, EndY, sizeOne, SizeTwo)
	...
	self.SizeOne = sizeOne or 0	-- SizeOne and SizeTwo jointly control the size of the icon. The logic is not intuitive.
	self.SizeTwo = SizeTwo or 0	-- For more details on the SizeOne and SizeTwo parameters, see http://wowwiki.wikia.com/wiki/UI_escape_sequences#Textures
