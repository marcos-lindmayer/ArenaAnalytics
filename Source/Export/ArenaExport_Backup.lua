...
local exportPrefix = "ArenaAnalytics:" ..
-- Match data
"date,season,player,playerSpec,bracket,map,duration,outcome,matchType,rating,ratingDelta,mmr,enemyRating,enemyRatingDelta,enemyMMR,firstDeath,"..
