...
function AAmatch:insertArenaOnTable()
	...
	if (arena["gotAllArenaInfo"] == false) then 
		-- print("Missing specs. Requesting data") --TODO
...
-- Resets stored arena values, removes arena events
...
-- caster if they weren't defined yet, otherwise adds a new unit with it
